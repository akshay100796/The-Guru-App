...
import com.codexdroid.theguru.databinding.FragmentPastEventsBinding
 ...
 *
 * Created by Akshay Pawar on © 06 August 2023, 12:58 PM
 * MH-15, India
 */

@AndroidEntryPoint
class PastEventsFragment : BaseFragment<FragmentPastEventsBinding, PastEventsViewModel>() {
    ...
    override fun requestSetUpListeners() {
        ...
        requestBinding().idImageClearText.setOnClickListener { requestViewModel().requestUpdateUi(
